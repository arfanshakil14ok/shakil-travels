...
export function TableHeader({ className, ...props }: React.HTMLAttributes<HTMLTableSectionElement>) {
  return <thead className={cn('bg-slate-50/80 border-b border-slate-200 text-slate-600', className)} {...props} />;
}
...
export function TableHead({ className, ...props }: React.ThHTMLAttributes<HTMLTableCellElement>) {
  return (
    <th
      className={cn(
        'h-11 px-4 text-xs font-semibold uppercase tracking-wider text-slate-500 align-middle select-none',
        className
      )}
      {...props}
    />
